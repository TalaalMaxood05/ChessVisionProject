...
class WarpConfig:
    ...
    output_size: int = 800          # Size of the rectified board image (square)
    square_size: int = 100           # Size of each individual square crop (480 / 8)
...
def compute_homography(
    ...
    padding: int = 200  # New: add some breathing room in pixels
